...
\code{dataTypes}     & tous & Types de données sur lesquels le plugin se charge, parmi les
                              quatre identifiants canoniques \code{"3d"} (volume figé),
                              \code{"2d"} (photographie calibrée), \code{"live"} (série 4D),
                              \code{"tracking"} (trajectoires cellulaires). Ex.
                              \code{["3d", "live", "tracking"]} pour un outil de volume,
...
\emph{sa nature}. Les quatre identifiants sont \code{"3d"}, \code{"2d"},
\code{"live"} et \code{"tracking"} --- les mêmes mots que le dossier sous
...
Un outil de mesure utilisable partout déclare les quatre
(\code{["3d","2d","live","tracking"]}). Attention, le filtre coupe des deux
